    ...
    <div className="flex flex-col md:flex-row gap-10 mt-10">
            ...
            <Dialog.Portal>
              ...
              >
                <Dialog.Close asChild>
                  <button
                    className="absolute right-4 top-4 text-gray-400 hover:text-gray-600 dark:hover:text-white transition text-2xl"
                    aria-label="close"
                  >
                    ✕
                  </button>
      ...
      <div className="md:w-2/3 text-[16px] leading-7 space-y-6">
        ...
        <div className="space-y-3">
          <p>
            Hello World, I am{" "}
            <strong className="text-sky-600 font-semibold">bionic bear</strong>
          </p>
          <p>A software engineering student graduate from TSU.</p>
          <p>
            A full-stack developer with a passion for building tools that
            connect real-world needs with data-driven,elegant code.
          </p>
          <p>
            Currently on a quest to change the system.Dreaming of becoming an
            intellectual and a poet.
          </p>
        </div>
        <div>
          <h1 className="text-lg font-bold mb-2 flex items-center gap-2">
        ...
        <div className="border-t pt-4 border-gray-300 text-[15px] space-y-1">
          ...
          <p>
            Email:{" "}
            <span className="text-purple-500 font-mono">suhaoxb@gmail.com</span>
          </p>
          <p>
            Wechat:{" "}
            <span className="text-purple-500 font-mono">bionic_bear</span>
          </p>
        </div>
      </div>
    </div>
